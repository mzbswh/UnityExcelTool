...
namespace ExcelToByteFile
{
    public static class ExcelDataMgr
    {
        ...
        public static ByteFileInfo<IdType> GetByteFileInfo<IdType>(short excelName)
        {
            if (byteFilefileInfoDict.TryGetValue(excelName, out var ret))
            {
        ...
        public static T Get<T, IdType>(short excelName, IdType id, int variableName)
        {
            if (byteFilefileInfoDict.TryGetValue(excelName, out object fileInfo))
            {
        ...
        public static Dictionary<K, V> GetDict<K, V, IdType>(short excelName, IdType id, int variableName)
        {
            if (byteFilefileInfoDict.TryGetValue(excelName, out object fileInfo))
            {
