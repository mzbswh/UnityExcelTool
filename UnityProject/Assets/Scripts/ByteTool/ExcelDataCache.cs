...
public sealed class ExcelDataCache
{
    ...
    private readonly Dictionary<int, object> byteFilefileInfoDict = new Dictionary<int, object>();
    ...
    private object GetByteFileInfo(ByteFileParam param)
    {
    ...
    public T Get<T, IdType>(ExcelName excelName, IdType id, int variableName)
    {
    ...
    public List<T> GetList<T, IdType>(ExcelName excelName, IdType id, int variableName)
    {
        if (byteFilefileInfoDict.TryGetValue((int)excelName, out object fileInfo))
        {
    ...
    public Dictionary<K, V> GetDict<K, V, IdType>(ExcelName excelName, IdType id, int variableName)
    {
        if (byteFilefileInfoDict.TryGetValue((int)excelName, out object fileInfo))
        {
    ...
    public Vector2 GetVector2<IdType>(ExcelName excelName, IdType id, int variableName)
    {
        if (byteFilefileInfoDict.TryGetValue((int)excelName, out object fileInfo))
        {
    ...
    public Vector2Int GetVector2Int<IdType>(ExcelName excelName, IdType id, int variableName)
    {
        if (byteFilefileInfoDict.TryGetValue((int)excelName, out object fileInfo))
        {
    ...
    public Vector3 GetVector3<IdType>(ExcelName excelName, IdType id, int variableName)
    {
        if (byteFilefileInfoDict.TryGetValue((int)excelName, out object fileInfo))
        {
    ...
    public Vector3Int GetVector3Int<IdType>(ExcelName excelName, IdType id, int variableName)
    {
        if (byteFilefileInfoDict.TryGetValue((int)excelName, out object fileInfo))
        {
    ...
    public Vector4 GetVector4<IdType>(ExcelName excelName, IdType id, int variableName)
    {
        if (byteFilefileInfoDict.TryGetValue((int)excelName, out object fileInfo))
        {
